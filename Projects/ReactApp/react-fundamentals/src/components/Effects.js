        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Effects can return cleanup functions, which can clean up timers using memo
                        ry, listeners to outside API's, and other functions which may use system resources</li>
                </ul>
                <SampleEffect />
                <br />
                <SampleEffect />
...
const SampleEffect = () => {
    ...
    useEffect(() => {
        ...
        return () => {
            window.clearTimeout(timer); console.log('the timer was cleaned up', Date.now
                () / 1000)
        };
    });
