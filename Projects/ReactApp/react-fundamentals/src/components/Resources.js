    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <p>Below are some of the resources that we used throughout this app. Note: You'l
                    l have one challenge where you will be asked to make this page better.</p>
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="https://www.pluralsight.com/course/react-js-getting-started" targe
                            t="_blank">
                    ...
                    <li>
                        <a href="https://github.com/bmorelli25/interactive-bitcoin-price-chart" tar
                            get="_blank">
                            Bitcoin
                        </a>
                    </li>
